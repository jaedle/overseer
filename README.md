...
[![GoDoc](https://godoc.org/github.com/jaedle/overseer?status.svg)](https://godoc.org/github.com/jaedle/overseer)
...
```sh
go get github.com/jaedle/overseer
```
...
See [Config](https://godoc.org/github.com/jaedle/overseer#Config)uration options [here](https://godoc.org/github.com/jaedle/overseer#Config) and the runtime [State](https://godoc.org/github.com/jaedle/overseer#State) available to your program [here](https://godoc.org/github.com/jaedle/overseer#State).
...
* [Core `overseer` package](https://godoc.org/github.com/jaedle/overseer)
* [Common `fetcher.Interface`](https://godoc.org/github.com/jaedle/overseer/fetcher#Interface)
	* [File fetcher](https://godoc.org/github.com/jaedle/overseer/fetcher#File)
	* [HTTP fetcher](https://godoc.org/github.com/jaedle/overseer/fetcher#HTTP)
	* [S3 fetcher](https://godoc.org/github.com/jaedle/overseer/fetcher#S3)
	* [Github fetcher](https://godoc.org/github.com/jaedle/overseer/fetcher#Github)
